...
<div class="admin-content">
  ...
  <form class="am-form am-form-horizontal" method="post" action="insertGoods">
  ...
  <div class="am-form-group">
    <label for="doc-ipt-pwd-2" class="am-u-sm-2 am-form-label">发布人</label>
    <div class="am-u-sm-10">
      <input type="text" id="doc-ipt-pwd-2" name="publisher_name" placeholder="请输入您的名字">
    </div>
  </div>
